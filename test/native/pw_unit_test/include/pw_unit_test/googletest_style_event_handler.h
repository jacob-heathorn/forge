...
#define PW_UNIT_TEST_GOOGLETEST_PASSED_SUMMARY "[  \033[32mPASSED\033[0m  ] %d test(s)."
#define PW_UNIT_TEST_GOOGLETEST_DISABLED_SUMMARY "[ \033[33mDISABLED\033[0m ] %d test(s)."
#define PW_UNIT_TEST_GOOGLETEST_FAILED_SUMMARY "[  \033[31mFAILED\033[0m  ] %d test(s)."

#define PW_UNIT_TEST_GOOGLETEST_CASE_START "[ RUN      ] %s.%s"
#define PW_UNIT_TEST_GOOGLETEST_CASE_OK "[       \033[32mOK\033[0m ] %s.%s"
#define PW_UNIT_TEST_GOOGLETEST_CASE_FAILED "[  \033[31mFAILED\033[0m  ] %s.%s"
#define PW_UNIT_TEST_GOOGLETEST_CASE_DISABLED "[ \033[33mDISABLED\033[0m ] %s.%s"
...
class GoogleTestStyleEventHandler : public EventHandler {
 ...
 protected:
  ...
  virtual void WriteLine(const char* format, ...) __attribute__((format(gnu_printf, 2, 3))) = 0;
